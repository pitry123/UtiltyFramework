...
private:
	...
	void InitializeTables()
	{
		...
		m_dataset[ProjectCommon::GreenRedTable1][ApplicationSampleDB::GreenRedTable::ROW_1].Write<ApplicationSampleDB::MyData>(data);
		m_dataset[ProjectCommon::GreenRedTable1][ApplicationSampleDB::GreenRedTable::ROW_2].Write<int>(utils::random_int(100));
...
protected:
	...
	{
		AddRemoteAgentTable(ProjectCommon::MonitorDBIndex::GreenRedTable1, ProjectCommon::MonitorDBIndex::GreenRedTable1, Database::table_info::exported_or_imported_flag::EXPORTED);
		AddRemoteAgentTable(ProjectCommon::MonitorDBIndex::GreenRedTable2, ProjectCommon::MonitorDBIndex::GreenRedTable2, Database::table_info::exported_or_imported_flag::EXPORTED);
