...
namespace video
{
	...
	{
		class DLL_EXPORT gstreamer_rtsp_server : public core::video::video_publisher_interface
		{
		public:
			virtual ~gstreamer_rtsp_server() = default;
			...
			static bool create(const char* stream_name, 
				uint16_t port, 
				core::video::video_source_factory_interface* source_factory, 
				core::video::video_publisher_interface** publisher);
		};
